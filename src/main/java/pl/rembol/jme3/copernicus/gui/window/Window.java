package pl.rembol.jme3.copernicus.gui.window;
...
abstract public class Window extends Node {
    ...
    public Window(GameState gameState, String name) {
        this(gameState, name, new Vector2f(gameState.settings.getWidth(), gameState.settings.getHeight()));
    }
    
    public Window(GameState gameState, String name , Vector2f size) {
        super(name);
